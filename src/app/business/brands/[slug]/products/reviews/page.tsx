...
function ProductReviewsQuickModal({ brandId, brand, product, onClose }: { brandId?: string, brand?: any, product?: any, onClose: () => void }) {
    const { t } = useLanguage();
    const open = !!product;
            ...
            <DialogContent className="max-w-3xl">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        {!!brandId && !!productId && (
                            <Link className="text-sm text-blue-600 hover:underline" href={`/business/brands/${brand.slug}/products/${productId}/reviews`}>

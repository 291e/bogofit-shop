...
export default function BrandsPage() {
  ...
  // Set page title
  useEffect(() => {
    document.title = `${t("brands.title")} - BOGOFIT`;
  }, [t]);
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white border-b sticky top-0 z-10">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-gray-600 mb-6">{t("brands.description")}</p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <p className="text-gray-600">
            {t("brands.totalBrands").replace("{count}", filteredBrands.length.toString())}
          </p>
        </div>
        ...
        {error ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t("brands.error")}</h3>
          ...
          <div className="flex items-center justify-center py-20">
            ...
            <span className="ml-2 text-gray-600">{t("brands.loading")}</span>
          </div>
        ) : filteredBrands.length === 0 ? (
          <div className="text-center py-20">
            <Store className="h-16 w-16 text-gray-300 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-gray-900 mb-2">{t("brands.noBrands")}</h3>
            <p className="text-gray-600">{t("brands.noBrandsDescription")}</p>
          </div>
        ) : (
          <motion.div
            initial={{ opacity: 0 }}

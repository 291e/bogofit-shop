...
import { ProductDetailImageForm } from "@/components/(Public)/solution/product/ProductDetailImageForm";
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <Tabs defaultValue="product" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-6">
          <TabsTrigger value="product">{t("ui.solution.product.title")}</TabsTrigger>
          <TabsTrigger value="fashion">{t("ui.solution.fashion.title")}</TabsTrigger>
        </TabsList>

        <TabsContent value="product">
          <Card>
            <CardHeader>
              <CardTitle>{t("ui.solution.product.title")}</CardTitle>
              <p className="text-sm text-gray-600 mt-2">
                {t("ui.solution.product.description")}
              </p>
            </CardHeader>
            <CardContent>

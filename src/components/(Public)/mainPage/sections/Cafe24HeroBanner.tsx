...
const heroBannerSlides: HeroBannerSlide[] = [
  ...
  },
  {
    ...
    title: "캐주얼 룩",
    subtitle: "편안한 스타일",
    description: "일상에서 완벽한 캐주얼 룩을 연출하세요"
  },
  {
    id: "slide-3",
    ...
    title: "비즈니스 룩",
    subtitle: "프로페셔널 스타일",
    description: "세련된 비즈니스 웨어로 자신감을 표현하세요"
  },
  {
    id: "slide-4",
    ...
    title: "스포츠 웨어",
    subtitle: "액티브 라이프",
    description: "운동과 일상을 모두 만족시키는 스포츠웨어"
  },
  {
    id: "slide-5",
    ...
    title: "데이트 룩",
    subtitle: "로맨틱 스타일", 
    description: "특별한 순간을 위한 완벽한 데이트 룩"
  },
  {
    id: "slide-6",
    ...
    title: "파티 룩",
    subtitle: "글램한 스타일",
    description: "특별한 밤을 위한 화려한 파티 룩"
  }
];

// 모든 이미지 URL 추출
const heroImageUrls = heroBannerSlides.map(slide => slide.image);

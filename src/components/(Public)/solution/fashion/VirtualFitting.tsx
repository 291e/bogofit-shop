      ...
      if (isProEnabled && (aiVersion === 'v2' || aiVersion === 'v3')) {
        ...
        try {
          const videoResult = await videoGeneration.mutateAsync({
            prompt: `Fashionshow turning: A model wearing ${productTitle || 'fashionable clothing'} turning and rotating 360 degrees on a runway. Fashion show presentation, professional model pose, smooth turning motion, showing front, side, back views. Vertical 9:16 format. Fashion runway style.`,
            imageUrl: result.imageUrl,
            negativePrompt: "blurry, distorted, low quality, artifacts, bad proportions, deformed, ugly, multiple people, crowd, background people, text overlay, watermark"
          });
